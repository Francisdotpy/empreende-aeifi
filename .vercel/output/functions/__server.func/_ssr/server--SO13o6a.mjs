...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BUgYCq2J.mjs");
...
var manifest = {
	"0dfe155c2cb79184130c1b715681133fd26d0a90c479ab76f5ff4b049639fe39": {
		functionName: "sendAssociationRequest_createServerFn_handler",
		importer: () => import("./association.functions-BSZOhE28.mjs")
	},
	"420039d888d6f92ecb02d2e25a67a5644d3a2ad34e92c5fcd0204779278c07c3": {
		functionName: "claimAdmin_createServerFn_handler",
		importer: () => import("./admin.functions-CyLIdH6X.mjs")
	},
	"87c9c96ef0822f31202a3a0ee43e0d91281993e49cb43e4cb7f78161174ea80a": {
		functionName: "uploadSiteFile_createServerFn_handler",
		importer: () => import("./uploads.functions-CpuXbArf.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B2yRfqy2.mjs").then((n) => n.t),
		import("./start-BTBrBL-A.mjs"),
