...
const inputClass =
  "w-full rounded-lg border border-input bg-card px-3 py-2.5 text-sm font-normal text-foreground shadow-sm hover:border-primary/30 focus:border-ring focus:outline-none focus:ring-2 focus:ring-ring/20";
    ...
    <Card>
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-secondary px-4 py-2.5 text-sm font-semibold text-secondary-foreground shadow-sm transition-all hover:bg-secondary/90 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50"
        >
      ...
      {formOpen ? (
        <form onSubmit={submit} className="mt-6 grid gap-5 border border-border bg-muted/30 p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="rounded-md p-2 text-muted-foreground hover:bg-muted hover:text-primary disabled:opacity-50"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
        ...
        {isLoading ? (
          ...
          <ul className="grid gap-3">
            {editais.map((edital) => (
              <li
                key={edital.id}
                className="grid gap-4 border border-border bg-card p-4 shadow-sm sm:grid-cols-[5rem_minmax(0,1fr)_auto] sm:items-center"
              >
                <img
                ...
                <div className="flex flex-wrap gap-2 sm:justify-end">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-semibold text-primary hover:bg-muted disabled:opacity-50"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-semibold text-secondary hover:bg-muted"
                  >
                  ...
                  <button
                    ...
                    disabled={busy || deletingId !== null}
                    className="inline-flex items-center gap-1.5 rounded-md border border-destructive/30 px-3 py-2 text-xs font-semibold text-destructive hover:bg-destructive/10 disabled:opacity-50"
                  >
